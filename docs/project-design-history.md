...
> **Document historique.**
> Ce document reflète la conception initiale du projet autour de la version
> 0.1. Il est conservé pour expliquer les décisions d'origine, mais il ne
> décrit plus l'état actuel du produit ni sa feuille de route. Consultez
> [Architecture](./architecture.md) et la documentation courante pour le
> comportement actuel.
